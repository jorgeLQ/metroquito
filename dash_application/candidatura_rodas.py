...
c1 = pd.read_excel('static/archivos/candidatura_Rodas.xlsx')
...
def create_dash_application2(flask_app):
    dash_app = dash.Dash(server=flask_app, name="Dashboard", url_base_pathname="/mauriciorodas/",external_stylesheets=[dbc.themes.BOOTSTRAP])
                        ...
                        html.Div([
                            html.Div([
                                html.Div([
                                    html.Div([
                                        html.Div([
                                            html.Img(src=('../static/images/Rodas.png'),style={'width': '90px'}),

                                        ],className='col-xl-6 col-md-6 mb-6'),
                                        html.Div([
                                            html.Span(" Mauricio Rodas ",style=NAME_ALCALDE),
                                            html.Span("14/05/2014 - 14/05/2019"),
                            ...
                            html.Div([
                                html.Div([
                                    html.Div([
                                        ...
                                        html.Img(src=('../static/images/word_cloud_c2.png'),style={'width': '100%','height': '365px'}),
                                    ],className='row no-gutters text-center'),
                                ],className='card-body'),
                            ],className='card shadow py-2'),
                        ],className='col-xl-3 col-md-6 mb-3'),
