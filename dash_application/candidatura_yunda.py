...
c1 = pd.read_excel('static/archivos/candidatura_Yunda.xlsx')
...
def create_dash_application3(flask_app):
    dash_app = dash.Dash(server=flask_app, name="Dashboard", url_base_pathname="/jorgeyunda/",external_stylesheets=[dbc.themes.BOOTSTRAP])
                        ...
                        html.Div([
                            html.Div([
                                html.Div([
                                    html.Div([
                                        html.Div([
                                            html.Img(src=('../static/images/Yunda.png'),style={'width': '90px'}),

                                        ],className='col-xl-6 col-md-6 mb-6'),
                                        html.Div([
                                            html.Span(" Jorge Yunda ",style=NAME_ALCALDE),
                                            html.Span("14/05/2019 - 29/09/2021"),
